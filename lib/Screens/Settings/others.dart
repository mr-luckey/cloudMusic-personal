...
import 'package:blackhole/bloc/others_settings/others_settings_bloc.dart';
...
class OthersPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => OthersSettingsBloc(),
      child: const _OthersPageContent(),
    );
  }
}

class _OthersPageContent extends StatefulWidget {
  const _OthersPageContent();

  @override
  State<_OthersPageContent> createState() => _OthersPageContentState();
}

class _OthersPageContentState extends State<_OthersPageContent> {
  ...
  @override
  void dispose() {
    includeOrExclude.dispose();
    super.dispose();
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<OthersSettingsBloc, OthersSettingsState>(
              ...
              children: [
                  ...
                  trailing: DropdownButton(
                    ...
                    onChanged: (String? newValue) {
                      if (newValue != null) {
                        ...
                        context.read<OthersSettingsBloc>().add(
                              OthersLanguageChanged(newValue),
                            );
                      }
                    },
                ...
                BoxSwitchTile(
                  ...
                  onChanged: ({required bool val, required Box box}) {
                    context.read<OthersSettingsBloc>().add(
                          OthersUseProxyChanged(val),
                        );
                  },
                ),
                Visibility(
                  visible: state.useProxy,
                  child: ListTile(
                    title: Text(
                      AppLocalizations.of(
                        context,
                ...
                ListTile(
                  ...
                  trailing: SizedBox(
                    ...
                    child: Center(
                      child: FutureBuilder(
                        key: ValueKey(state.refreshTick),
